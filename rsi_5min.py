        ...
        while True:
            ...
            if Position == "0":
                ...
                if float(RSI_New) >= 30 and float(rsi_Old) <= 30:
                    ...
                    trade = "INSERT INTO rsi_trades_5m (Name, Token, Type, Qty, Price, IdxPrice, Position, DateTime, Strategy, SL, Profit, TSL) values ('"+str(symbol.replace("'", ""))+"', '"+str(tokenresult.replace("'", ""))+"', 'BUY', '30', '"+str(option_live)+"', '"+str(Idx_Live)+"', '1', '"+str(datetime.datetime.now())+"', 'Rsi_Trades_5m', 'RSI30', '"+str(MA_New)+"', '"+str(float(option_live)+50)+"')"
                    mycursor.execute(trade)
                    mydb.commit()

                    data = "{'TSL': '0', 'Target': '"+str(float(option_live)+50)+"'}"
                    with open('rsi_5m.json', 'w') as outfile:
                        outfile.write(data)
                        outfile.close()
                ...
                if float(RSI_New) >= 25 and float(rsi_Old) <= 25:
                    ...
                    trade = "INSERT INTO rsi_trades_5m (Name, Token, Type, Qty, Price, IdxPrice, Position, DateTime, Strategy, SL, Profit, TSL) values ('"+str(symbol.replace("'", ""))+"', '"+str(tokenresult.replace("'", ""))+"', 'BUY', '30', '"+str(option_live)+"', '"+str(Idx_Live)+"', '1', '"+str(datetime.datetime.now())+"', 'Rsi_Trades_5m', 'RSI25', '"+str(MA_New)+"', '"+str(float(option_live)+50)+"')"
                    mycursor.execute(trade)
                    mydb.commit()
                ...
                if float(RSI_New) <= 70 and float(rsi_Old) >= 70:
                    ...
                    trade = "INSERT INTO rsi_trades_5m (Name, Token, Type, Qty, Price, IdxPrice, Position, DateTime, Strategy, SL, Profit, TSL) values ('"+str(symbol.replace("'", ""))+"', '"+str(tokenresult.replace("'", ""))+"', 'BUY', '30', '"+str(option_live)+"', '"+str(Idx_Live)+"', '1', '"+str(datetime.datetime.now())+"', 'Rsi_Trades_5m', 'RSI_70', '"+str(MA_New)+"', '"+str(float(option_live)+50)+"')"
                    mycursor.execute(trade)
                    mydb.commit()
                ...
                if float(RSI_New) <= 75 and float(rsi_Old) >= 75:
                    ...
                    trade = "INSERT INTO rsi_trades_5m (Name, Token, Type, Qty, Price, IdxPrice, Position, DateTime, Strategy, SL, Profit, TSL) values ('"+str(symbol.replace("'", ""))+"', '"+str(tokenresult.replace("'", ""))+"', 'BUY', '30', '"+str(option_live)+"', '"+str(Idx_Live)+"', '1', '"+str(datetime.datetime.now())+"', 'Rsi_Trades_5m', 'RSI_75', '"+str(MA_New)+"', '"+str(float(option_live)+50)+"')"
                    mycursor.execute(trade)
                    mydb.commit()
                ...
                if  float(RSI_New) <= 84.99 and float(rsi_Old) >= 85:
                    ...
                    trade = "INSERT INTO rsi_trades_5m (Name, Token, Type, Qty, Price, IdxPrice, Position, DateTime, Strategy, SL, Profit, TSL) values ('"+str(symbol.replace("'", ""))+"', '"+str(tokenresult.replace("'", ""))+"', 'BUY', '30', '"+str(option_live)+"', '"+str(Idx_Live)+"', '1', '"+str(datetime.datetime.now())+"', 'Rsi_Trades_5m', 'RSI85', '"+str(MA_New)+"', '"+str(float(option_live)+50)+"')"
                    mycursor.execute(trade)
                    mydb.commit()
            ...
            if Position == "1":
                ...
                with open('rsi_5m.json', 'r') as outfile:
                   data = outfile.read()
