...
def Angle_Buy_Order(Api, Api_Secret, Totp, ClientID, Password, symbol, token, strategy, userid, producttype, quantity):
    print(producttype)
...
def Angle_Sell_Order(Api, Api_Secret, Totp, ClientID, Password, symbol, token, strategy, userid, producttype, quantity):
    clientId = ClientID
    api_key = Api
    pwd = Password
    smartApi = SmartConnect(api_key)
