...
def MA():
    ...
    file_path = "./CSV_Files/bnf_15m.csv"  # Replace 'your_file_path.csv' with your CSV file path
    df = pd.read_csv(file_path)
...
while True:
    ...
    if str(datetime.datetime.now()) >= str(data.date())+" 09:30:00.000000":
        ...
        while True:
            ...
            sql = "select * from ema_rsi_trades ORDER BY DateTime DESC"
            ...
            if Position == "0":
                ...
                if float(RSI_New) >= 30 and float(rsi_Old) <= 30:
                    ...
                    Buy_Order(str(symbol.replace("'", "")), str(tokenresult), "EMA_Rsi_Trades", DhanSymbol, AliceSymbol, UpstoxSymbol, FyresSymbol, MotilalSymbol, Zerodha, str(strikeprice), "call", IciciExpiry)

                    trade = "INSERT INTO ema_rsi_trades (Name, Token, Type, Qty, Price, IdxPrice, Position, DateTime, Strategy, SL, Profit, TSL) values ('"+str(symbol.replace("'", ""))+"', '"+str(tokenresult.replace("'", ""))+"', 'BUY', '30', '"+str(option_live)+"', '"+str(Idx_Live)+"', '1', '"+str(datetime.datetime.now())+"', 'EMA_Rsi_Trades', 'RSI30', '"+str(MA_New)+"', '"+str(float(option_live)+50)+"')"
                    mycursor.execute(trade)
                    mydb.commit()

                    data = "{'TSL': '0', 'Target': '"+str(float(option_live)+50)+"'}"
                    with open('ema_rsi_15m.json', 'w') as outfile:
                        outfile.write(data)
                        outfile.close()
                ...
                if float(RSI_New) >= 25 and float(rsi_Old) <= 25:
                    ...
                    trade = "INSERT INTO ema_rsi_trades (Name, Token, Type, Qty, Price, IdxPrice, Position, DateTime, Strategy, SL, Profit, TSL) values ('"+str(symbol.replace("'", ""))+"', '"+str(tokenresult.replace("'", ""))+"', 'BUY', '30', '"+str(option_live)+"', '"+str(Idx_Live)+"', '1', '"+str(datetime.datetime.now())+"', 'EMA_Rsi_Trades', 'RSI25', '"+str(MA_New)+"', '"+str(float(option_live)+50)+"')"
                    mycursor.execute(trade)
                    mydb.commit()
                ...
                if (rsi_Old) <= 20:
                    ...
                    trade = "INSERT INTO ema_rsi_trades (Name, Token, Type, Qty, Price, IdxPrice, Position, DateTime, Strategy, SL, Profit, TSL) values ('"+str(symbol.replace("'", ""))+"', '"+str(tokenresult.replace("'", ""))+"', 'BUY', '30', '"+str(option_live)+"', '"+str(Idx_Live)+"', '1', '"+str(datetime.datetime.now())+"', 'EMA_Rsi_Trades', 'RSI20', '"+str(MA_New)+"', '"+str(float(option_live)+50)+"')"
                    mycursor.execute(trade)
                    mydb.commit()
                ...
                if float(MA_Smoothing) < float(MA_New) and float(ma_old_Smoothing) > float(ma_old):
                    ...
                    trade = "INSERT INTO ema_rsi_trades (Name, Token, Type, Qty, Price, IdxPrice, Position, DateTime, Strategy, SL, Profit, TSL) values ('"+str(symbol.replace("'", ""))+"', '"+str(tokenresult.replace("'", ""))+"', 'BUY', '30', '"+str(option_live)+"', '"+str(Idx_Live)+"', '1', '"+str(datetime.datetime.now())+"', 'EMA_Rsi_Trades', '"+str(MA_New)+"', 'RSI_75', '"+str(float(option_live)+50)+"')"
                    mycursor.execute(trade)
                    mydb.commit()
                ...
                if float(RSI_New) <= 70 and float(rsi_Old) >= 70:
                    ...
                    option_live = Option_Idx_Price(apikey, secretkey, user_id, password, totp, str(symbol.replace("'", "")), str(tokenresult.replace("'", "")))
                    #str(tokenresult[0].replace("'", ""))
                    Buy_Order(str(symbol.replace("'", "")), str(tokenresult), "EMA_Rsi_Trades", DhanSymbol, AliceSymbol, UpstoxSymbol, FyresSymbol, MotilalSymbol, Zerodha, str(strikeprice), "put", IciciExpiry)


                    trade = "INSERT INTO ema_rsi_trades (Name, Token, Type, Qty, Price, IdxPrice, Position, DateTime, Strategy, SL, Profit, TSL) values ('"+str(symbol.replace("'", ""))+"', '"+str(tokenresult.replace("'", ""))+"', 'BUY', '30', '"+str(option_live)+"', '"+str(Idx_Live)+"', '1', '"+str(datetime.datetime.now())+"', 'EMA_Rsi_Trades', 'RSI_70', '"+str(MA_New)+"', '"+str(float(option_live)+50)+"')"
                    mycursor.execute(trade)
                    mydb.commit()
                ...
                if float(RSI_New) <= 75 and float(rsi_Old) >= 75:
                    ...
                    trade = "INSERT INTO ema_rsi_trades (Name, Token, Type, Qty, Price, IdxPrice, Position, DateTime, Strategy, SL, Profit, TSL) values ('"+str(symbol.replace("'", ""))+"', '"+str(tokenresult.replace("'", ""))+"', 'BUY', '30', '"+str(option_live)+"', '"+str(Idx_Live)+"', '1', '"+str(datetime.datetime.now())+"', 'EMA_Rsi_Trades', 'RSI_75', '"+str(MA_New)+"', '"+str(float(option_live)+50)+"')"
                    mycursor.execute(trade)
                    mydb.commit()
                ...
                if float(RSI_New) <= 80 and float(rsi_Old) >= 80:
                    ...
                    trade = "INSERT INTO ema_rsi_trades (Name, Token, Type, Qty, Price, IdxPrice, Position, DateTime, Strategy, SL, Profit, TSL) values ('"+str(symbol.replace("'", ""))+"', '"+str(tokenresult.replace("'", ""))+"', 'BUY', '30', '"+str(option_live)+"', '"+str(Idx_Live)+"', '1', '"+str(datetime.datetime.now())+"', 'EMA_Rsi_Trades', 'RSI_80', '"+str(MA_New)+"', '"+str(float(option_live)+50)+"')"
                    mycursor.execute(trade)
                    mydb.commit()
                ...
                if float(RSI_New) >= 85:
                    ...
                    trade = "INSERT INTO ema_rsi_trades (Name, Token, Type, Qty, Price, IdxPrice, Position, DateTime, Strategy, SL, Profit, TSL) values ('"+str(symbol.replace("'", ""))+"', '"+str(tokenresult.replace("'", ""))+"', 'BUY', '30', '"+str(option_live)+"', '"+str(Idx_Live)+"', '1', '"+str(datetime.datetime.now())+"', 'EMA_Rsi_Trades', 'RSI_85', '"+str(MA_New)+"', '"+str(float(option_live)+50)+"')"
                    mycursor.execute(trade)
                    mydb.commit()
                ...
                if float(MA_Smoothing) > float(MA_New) and float(ma_old_Smoothing) < float(ma_old):
                    ...
                    trade = "INSERT INTO ema_rsi_trades (Name, Token, Type, Qty, Price, IdxPrice, Position, DateTime, Strategy, SL, Profit, TSL) values ('"+str(symbol.replace("'", ""))+"', '"+str(tokenresult.replace("'", ""))+"', 'BUY', '30', '"+str(option_live)+"', '"+str(Idx_Live)+"', '1', '"+str(datetime.datetime.now())+"', 'EMA_Rsi_Trades', '"+str(MA_New)+"', 'RSI20', '"+str(float(option_live)+50)+"')"
                    mycursor.execute(trade)
                    mydb.commit()
            ...
            if Position == "1":
                ...
                with open('ema_rsi_15m.json', 'r') as outfile:
                   data = outfile.read()
                ...
                if str(datetime.datetime.now()) >= str(data.date())+" 15:27:00.000000":
                    Sell_Order(Symbol, Token, "EMA_Rsi_Trades")
                    trade = "INSERT INTO ema_rsi_trades (Name, Token, Type, Qty, Price, IdxPrice, Position, DateTime, Strategy, SL, Profit, TSL) values ('"+str(Symbol.replace("'", ""))+"', '"+str(Token.replace("'", ""))+"', 'SELL', '30', '"+str(Option_live)+"', '"+str(Idx_Live)+"', '0', '"+str(datetime.datetime.now())+"', 'BNF', '0', '0', '0')"
                    mycursor.execute(trade)
                    mydb.commit()
                    exit()
                ...
                if float(Option_live) <= float(Option_Price)-30:
                    Sell_Order(Symbol, Token, "EMA_Rsi_Trades")
                    trade = "INSERT INTO ema_rsi_trades (Name, Token, Type, Qty, Price, IdxPrice, Position, DateTime, Strategy, SL, Profit, TSL) values ('"+str(Symbol.replace("'", ""))+"', '"+str(Token.replace("'", ""))+"', 'SL', '30', '"+str(Option_live)+"', '"+str(Idx_Live)+"', '0', '"+str(datetime.datetime.now())+"', 'EMA_Rsi_Trades', '0', '0', '0')"
                    mycursor.execute(trade)
                    mydb.commit()
                ...
                if "CE" in Symbol:
                    ...
                    if Sl == "RSI20":
                        ...
                        if float(Idx_Live) >= float(MA_New):
                            ...
                            Sell_Order(Symbol, Token, "EMA_Rsi_Trades")
                            trade = "INSERT INTO ema_rsi_trades (Name, Token, Type, Qty, Price, IdxPrice, Position, DateTime, Strategy, SL, Profit, TSL) values ('"+str(Symbol.replace("'", ""))+"', '"+str(Token.replace("'", ""))+"', 'SELL', '30', '"+str(Option_live)+"', '"+str(Idx_Live)+"', '0', '"+str(datetime.datetime.now())+"', 'EMA_Rsi_Trades', '0', '0', '0')"
                            mycursor.execute(trade)
                            mydb.commit()
                            current_datetime = datetime.datetime.now()
